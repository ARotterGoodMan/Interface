...
import com.example.api.entity.home.homedata2.popdatas.popdataslist.DataPage5list;
import com.example.api.entity.home.homedata2.publicdata.PublicDatas;

import java.util.LinkedHashMap;

public class DataPage5 {
    ...
    public void setData() {
        ...
        DataPage5list dataPage5list = new DataPage5list();
        dataPage5list.setList0();
        dataPage5list.setLists();
        setList(dataPage5list.getLists());
        this.data.put("list", getList());
        this.data.put("page", getPage());
        setParam();
