...
import com.example.api.entity.home.homedata2.popdatas.popdataslist.DataPage3list;
import com.example.api.entity.home.homedata2.publicdata.PublicDatas;

import java.util.LinkedHashMap;

public class DataPage3 {
    ...
    public void setData() {
        ...
        DataPage3list dataPage3list = new DataPage3list();
        dataPage3list.setList0();
        dataPage3list.setLists();
        setList(dataPage3list.getLists());
        this.data.put("list",getList());
        this.data.put("page", 3);
        setParam();
