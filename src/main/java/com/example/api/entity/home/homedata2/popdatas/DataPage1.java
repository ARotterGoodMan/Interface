...
import com.example.api.entity.home.homedata2.popdatas.popdataslist.DataPage1list;
...
public class DataPage1 {
    ...
    public void setData() {
        ...
        DataPage1list dataPage1list = new DataPage1list();
        dataPage1list.setList0();
        dataPage1list.setLists();
        setList(dataPage1list.getLists());
