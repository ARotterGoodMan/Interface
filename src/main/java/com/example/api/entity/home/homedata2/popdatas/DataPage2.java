...
import com.example.api.entity.home.homedata2.popdatas.popdataslist.DataPage2list;
...
public class DataPage2 {
    ...
    public void setData() {
        ...
        DataPage2list dataPage2list = new DataPage2list();
        dataPage2list.setList0();
        dataPage2list.setLists();
        setList(dataPage2list.getLists());
        this.data.put("list",getList());
        this.data.put("page", 2);
        setParam();
